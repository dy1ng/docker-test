    ...
    steps {
        script {
            ...
            scriptContent = """
                ...
                echo "${'$'}json"
                curl -u dy1ng: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 -X POST -H "Accept: application/vnd.github.v3+json" https://api.github.com/repos/dy1ng/teamcity-documentation/pulls -d "${'$'}json"
            """.trimIndent()
        }
        script {
