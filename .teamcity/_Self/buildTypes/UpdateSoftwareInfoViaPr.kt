    ...
    steps {
        script {
            ...
            scriptContent = """
                ...
                git commit -m "${'$'}commit_msg" || echo "##teamcity[buildProblem description='Build skipped. No new data to add.' identity='build_skipped_no_new_data']" && echo "##teamcity[buildStatus status='SUCCESS']" && exit 0
