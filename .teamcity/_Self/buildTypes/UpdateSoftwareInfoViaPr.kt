    ...
    steps {
        script {
            ...
            scriptContent = """
                ...
                echo "${'$'}json"
                #curl -u dy1ng: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 -X POST -H "Accept: application/vnd.github.v3+json" https://api.github.com/repos/dy1ng/teamcity-documentation/pulls -d "${'$'}json"
            """.trimIndent()
        }
        script {
